...
**v2.3.0-rc.1 · independent testing and demonstration project.** Made by Akila DJ
...
air-quality data on a map. This is not an official AirGradient product.
...
Download and extract the [release ZIP](https://github.com/GGadash/AirGradient-Test-API-App/releases/tag/v2.3.0-rc.1), run
