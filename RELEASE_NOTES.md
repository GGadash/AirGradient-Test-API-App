# AirGradient Test API App v2.2.0-rc.1

**Release candidate — for testing and demonstration.** The Python + localhost app remains the main product. This release adds a
supplementary GitHub Pages preview for easier access without installation.
...
3. Download **AirGradient-Test-API-App-v2.2.0-rc.1.zip** from this release's **Assets** and extract it.
...
[Short setup guide](https://github.com/GGadash/AirGradient-Test-API-App/blob/v2.2.0-rc.1/START_HERE.md) ·
[Full user guide](https://github.com/GGadash/AirGradient-Test-API-App/blob/v2.2.0-rc.1/README.md)
...
or use the main local app. [Full supplementary guide](https://github.com/GGadash/AirGradient-Test-API-App/blob/v2.2.0-rc.1/web/README.md).

## Included changes

- Main local app preserved, with updated release information and a supplementary-page link.
- Added the labelled web preview, public-data collector, nominal 15-minute publishing workflow, and tests for data handling and freshness.
...
[Full project license](https://github.com/GGadash/AirGradient-Test-API-App/blob/v2.2.0-rc.1/LICENSE) ·
[Official MIT-0 license](https://opensource.org/license/mit-0) ·
[Third-party notices](https://github.com/GGadash/AirGradient-Test-API-App/blob/v2.2.0-rc.1/THIRD_PARTY_NOTICES.md)
