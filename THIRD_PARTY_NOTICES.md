...
| AirGradient | Measurement API, device model names, and documentation links | [API documentation](https://api.airgradient.com/public/docs/api/v1/) and [AirGradient website](https://www.airgradient.com/). API availability, permissions, and data/service terms are controlled by the provider; this project's MIT-0 grant does not cover them. |
